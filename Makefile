#############################################################################
# Makefile for building: KittehPlayer
# Generated by qmake (3.1) (Qt 5.11.2)
# Project:  KittehPlayer.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile KittehPlayer.pro CONFIG+=release PREFIX=/usr
#############################################################################
...
INCPATH       = -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtQuickControls2 -isystem /usr/include/qt/QtQuick -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtQml -isystem /usr/include/qt/QtNetwork -isystem /usr/include/qt/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = KittehPlayer1.0.0
DISTDIR = /home/kitteh/KittehPlayer/.tmp/KittehPlayer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now -Wl,-rpath-link,/usr/lib
LIBS          = $(SUBLIBS) -lmpv -lQt5QuickControls2 -lQt5Quick -lQt5Widgets -lQt5Gui -lQt5Qml -lQt5Network -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = src/main.cpp \
		src/mpvobject.cpp qrc_qml.cpp \
		moc_mpvobject.cpp
OBJECTS       = main.o \
		mpvobject.o \
		qrc_qml.o \
		moc_mpvobject.o
DIST          = KittehPlayer.desktop \
		KittehPlayer.png \
		README.md \
		LICENSE.txt \
		...
		KittehPlayer.pro src/main.h \
		src/mpvobject.h \
		src/config.h src/main.cpp \
		src/mpvobject.cpp
QMAKE_TARGET  = KittehPlayer
DESTDIR       = 
TARGET        = KittehPlayer
...
Makefile: KittehPlayer.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile KittehPlayer.pro CONFIG+=release PREFIX=/usr
/usr/lib/qt/mkspecs/features/spec_pre.prf:
/usr/lib/qt/mkspecs/common/unix.conf:
/usr/lib/qt/mkspecs/common/linux.conf:
/usr/lib/qt/mkspecs/common/sanitize.conf:
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/qml/qml.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/qt/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.h src/mpvobject.h src/config.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/mpvobject.cpp $(DISTDIR)/
...
qrc_qml.cpp: src/qml/qml.qrc \
		/usr/bin/rcc \
		src/qml/codes.js \
		src/qml/main.qml \
		src/qml/fonts/NotoSans.ttf \
		src/qml/icons/volume-mute.svg \
		src/qml/icons/volume-down.svg \
		src/qml/icons/pause.svg \
		src/qml/icons/playlist.svg \
		src/qml/icons/settings.svg \
		src/qml/icons/prev.svg \
		src/qml/icons/volume-up.svg \
		src/qml/icons/play.svg \
		src/qml/icons/subtitles.svg \
		src/qml/icons/forward.svg \
		src/qml/icons/next.svg \
		src/qml/icons/backward.svg \
		src/qml/icons/fullscreen.svg
	/usr/bin/rcc -name qml src/qml/qml.qrc -o qrc_qml.cpp
...
compiler_moc_header_make_all: moc_mpvobject.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mpvobject.cpp
moc_mpvobject.cpp: src/config.h \
		src/mpvobject.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/kitteh/KittehPlayer/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/kitteh/KittehPlayer -I/usr/include/qt -I/usr/include/qt/QtQuickControls2 -I/usr/include/qt/QtQuick -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtQml -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtCore -I/usr/include/c++/8.2.1 -I/usr/include/c++/8.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/8.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.1/include-fixed -I/usr/include src/mpvobject.h -o moc_mpvobject.cpp
...
install_desktop: first FORCE
	...
	-$(QINSTALL) /home/kitteh/KittehPlayer/KittehPlayer.desktop $(INSTALL_ROOT)/usr/share/applications/KittehPlayer.desktop

uninstall_desktop: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/applications/KittehPlayer.desktop
...
install_icon: first FORCE
	...
	-$(QINSTALL) /home/kitteh/KittehPlayer/KittehPlayer.png $(INSTALL_ROOT)/usr/share/icons/hicolor/256x256/apps/KittehPlayer.png

uninstall_icon: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/icons/hicolor/256x256/apps/KittehPlayer.png
